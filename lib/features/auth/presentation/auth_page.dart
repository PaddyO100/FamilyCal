...
class _AuthPageState extends State<AuthPage> {
  ...
  Future<void> _createOrUpdateUser(AppUser user) async {
    ...
    try {
      ...
      setState(() {
        if (error.code == 'operation-not-allowed') {
          _error = 'Diese Anmeldemethode ist aktuell deaktiviert. Bitte aktiviere sie in der Firebase-Konsole unter Authentifizierung → Anmeldemethoden.';
        } else {
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      setState(() {
        if (error.code == 'operation-not-allowed') {
          _error = 'Google-Anmeldung ist deaktiviert. Bitte aktiviere sie in der Firebase-Konsole.';
        } else if (error.code == 'network-request-failed') {
          _error = 'Netzwerkfehler bei der Google-Anmeldung. Prüfe deine Verbindung und versuche es erneut.';
        } else {
          _error = error.message;
        }
      });
      ...
      if (!mounted) return;
      setState(() {
        _error = 'Google-Anmeldung fehlgeschlagen: $error';
      });
    } finally {
      if (mounted) {
        setState(() {
