...
class _HouseholdSelectPageState extends State<HouseholdSelectPage> {
  ...
  Future<void> _joinHousehold() async {
    ...
    if (code.isEmpty) {
      setState(() {
        _error = 'Bitte gib einen Einladungscode ein.';
      });
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Haushalt erfolgreich beigetreten.')),
        );
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Als Admin kannst du weitere Mitglieder per Einladung hinzufügen und Rollenfarben definieren.',
