      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Zugewiesene Mitglieder', style: theme.textTheme.titleSmall),
            Wrap(
              spacing: 8,
                ...
                return FilterChip(
                  ...
                  onSelected: _saving
                      ...
                      : (value) {
                          setState(() {
                            if (value) {
                              _assigneeIds = List.of(_assigneeIds)..add(member.userId);
                            } else {
                              _assigneeIds = List.of(_assigneeIds)..remove(member.userId);
                            }
                          });
                        },
                );
